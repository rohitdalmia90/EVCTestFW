...
public class StudioSetting extends BrowserSelection implements OtherObjects{
	...
	public void verifyStudioMenu() throws InterruptedException, AWTException 
	{
		...
		studioActions.displaySiteSetting();
		studioActions.displaylandingPages();
		studioActions.displaynavigation();
		studioActions.displayrbacSettings();
		studioActions.displaystudioAccessControl();
		studioActions.displayworkflow();
