...
public class COD extends BrowserSelection implements OtherObjects{
	...
	public void verifyLandingScrnCOD() throws InterruptedException 
	{
	...
	public void verifyTwitterSocialNetwrk() throws InterruptedException, IOException
	{
		homeActions.clickHamburgerIcon();
		homeActions.enterValueInSearchField("social networking");
		String mainWindowHandle = commonActions.getDefaultWindowHandle();
	...
	public void verifyLinkedInSocialNetwrk() throws InterruptedException, IOException
	{
		homeActions.clickHamburgerIcon();
		homeActions.enterValueInSearchField("social networking");
		String mainWindowHandle = commonActions.getDefaultWindowHandle();
	...
	public void verifyVideoScreen() throws InterruptedException
	{
		...
		homeActions.clickVideosOptnSpan();
