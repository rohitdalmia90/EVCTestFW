...
public class SEARK extends BrowserSelection implements OtherObjects{
	...
	public void verifyLandingScrnSEARK() throws InterruptedException 
	{
		homeActions.waitForPageLoad();
		webActions.hardSleep();
		int headingText = homeActions.getSizeConnectHeading();
