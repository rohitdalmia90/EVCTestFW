...
public class HideGroupInfo extends BrowserSelection implements OtherObjects{
	...
	public void verifyHideGroupInfo() throws InterruptedException, AWTException 
	{
		...
		unifyedGroupActions.clickHideGroupInfo();
		unifyedGroupActions.clickGroupABC();
		String text= unifyedGroupActions.assertHideGroup();
		Assert.assertEquals(text, "abc");
		unifyedGroupActions.clicktx();
		unifyedGroupActions.clickUnifyedGroup();
		unifyedGroupActions.clickGroupabcIcon();
		unifyedGroupActions.clickShowGroupInfo();
		unifyedGroupActions.clickGroupABC();
		
//		unifyedGroupActions.clickEditGroup();
//		unifyedGroupActions.clickNextButton();
//		unifyedGroupActions.clickUpdateButton();
//		unifyedGroupActions.clickNextButton();
