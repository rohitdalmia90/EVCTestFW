...
public class CreateNewGroupPrivate extends BrowserSelection implements OtherObjects{
	...
	public void verifyCreateNewPrivateGroup() throws InterruptedException, AWTException 
	{
...
//		unifyedGroupActions.selectGroupAthletics();
		...
		unifyedGroupActions.selectPrivatePrivacy();
		unifyedGroupActions.clickNextButton();
		unifyedGroupActions.clickDropdownGroup();
		unifyedGroupActions.clickSelectAllUsers();
		unifyedGroupActions.clickNextButton();
		unifyedGroupActions.enterGroupNamePrivate();
