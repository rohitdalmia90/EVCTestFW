...
public class SearchBlockUser extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifySearchBlockUser() throws InterruptedException, AWTException 
	{
		...
		String request = chatActions.assertBlockconnection();
