...
public class DeclineOwnConnectionRequest extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyDeclineOwnConnectionRequest() throws InterruptedException, AWTException 
	{
		...
		chatActions.clickDeclineOwnRequest();
