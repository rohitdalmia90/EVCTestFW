...
public class CheckConnectionRequestReceived extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyConnectionRequestReceived() throws InterruptedException, AWTException 
	{
		homeActions.waitForPageLoad();
		webActions.hardSleep();
		chatActions.clickChatIcon();
		String request = chatActions.verifyConnectionRequest();
		Assert.assertNotEquals(request, " ");
