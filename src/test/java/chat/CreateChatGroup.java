...
public class CreateChatGroup extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyCreateChatGroup() throws InterruptedException, AWTException 
	{
		homeActions.waitForPageLoad();
		webActions.hardSleep();
		chatActions.clickChatIcon();
		chatActions.clickChatRooms();
		chatActions.clickCreateNewChatGroup();
		chatActions.clickChooseImage();
		chatActions.clickChooseImageIcon();
		chatActions.clickSaveChooseIcon();
		chatActions.enterGroupName();
		chatActions.clickAddConnectionGroupChat();
		chatActions.clickSubmitNewChatGroup();
