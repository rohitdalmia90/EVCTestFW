...
public class CheckConnectionRemoveRequest extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyCheckConnectionRemoveRequest() throws InterruptedException, AWTException 
	{
		...
		String search =chatActions.assertSearch();
		Assert.assertEquals(search, "Steve Rogers");
