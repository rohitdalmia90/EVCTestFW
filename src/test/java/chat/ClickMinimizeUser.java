...
public class ClickMinimizeUser extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyClickMinimizeUser() throws InterruptedException, AWTException 
	{
		homeActions.waitForPageLoad();
		webActions.hardSleep();
		chatActions.clickChatIcon();
		chatActions.clickIndividualChatUser();
		chatActions.clickMinimizeChat();
//		chatActions.clickCloseChat();
