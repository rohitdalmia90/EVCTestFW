...
public class VerifyCreateChatGroup extends BrowserSelection implements OtherObjects{
	...
	public void verifyCreateChatGroup() throws InterruptedException, AWTException 
	{
		...
		String groupName = chatActions.assertAutomationChatGroup();
		Assert.assertEquals(groupName, "Chat Automation");
