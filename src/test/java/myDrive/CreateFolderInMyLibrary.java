...
public class CreateFolderInMyLibrary extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyAssertAddInMyLibrary() throws InterruptedException, AWTException 
	{
...
//		Assert.assertEquals(myLibrary, "My Library");
		myDriveActions.CreateFolderMyDrive();
