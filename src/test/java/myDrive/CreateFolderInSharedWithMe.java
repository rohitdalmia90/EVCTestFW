...
public class CreateFolderInSharedWithMe extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyCreateFolderInSharedWithMe() throws InterruptedException, AWTException 
	{
...
//		myDriveActions.clicksearchBox();
		...
		myDriveActions.CreateFolderSharedWithMe();
	}
