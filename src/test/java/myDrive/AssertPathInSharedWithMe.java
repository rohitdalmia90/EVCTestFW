...
public class AssertPathInSharedWithMe extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyAssertPathInSharedWithMe() throws InterruptedException, AWTException 
	{
...
//		myDriveActions.clicksearchBox();
		...
		myDriveActions.clickSharedWithMe();
		String pathSharedWithMe=myDriveActions.assertTrailMenu();
		System.out.println(pathSharedWithMe);
//		Assert.assertEquals(sharedWithMe, "Shared with Me");
	}
