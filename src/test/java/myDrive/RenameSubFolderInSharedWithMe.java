...
public class RenameSubFolderInSharedWithMe extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyRenameFolderInSharedWithMe() throws InterruptedException, AWTException 
	{
...
//		myDriveActions.clicksearchBox();
		...
		myDriveActions.RenameFolderSharedWithMe();
