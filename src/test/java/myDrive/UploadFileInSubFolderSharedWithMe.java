...
public class UploadFileInSubFolderSharedWithMe extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyAssertSharedWithMe() throws InterruptedException, AWTException 
	{
...
//		myDriveActions.clicksearchBox();
		...
		String sharedWithMe=myDriveActions.assertSharedWithMe();
		Assert.assertEquals(sharedWithMe, "Shared with Me");
		myDriveActions.clickOnAdd();
		String newFolder=myDriveActions.assertNewFolder();
		System.out.println(newFolder);
//		Assert.assertEquals(myLibrary, "My Library");
		String uploadFile=myDriveActions.assertUploadFile();
