...
public class AssertPathInMyLibrary extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyAssertPathInMyLibrary() throws InterruptedException, AWTException 
	{
...
//		myDriveActions.clicksearchBox();
		...
		String LibraryPath=myDriveActions.assertTrailMenu();
		System.out.println(LibraryPath);
//		Assert.assertEquals(LibraryPath, "My Library");
	}
