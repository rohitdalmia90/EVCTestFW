...
public class RemoveSubFolderInSharedWithMe extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyRemoveFolderInSharedWithMe() throws InterruptedException, AWTException 
	{
...
//		myDriveActions.clicksearchBox();
		...
		myDriveActions.RemoveFolderSharedWithMe();
