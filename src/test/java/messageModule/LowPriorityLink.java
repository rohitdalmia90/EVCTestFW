...
public class LowPriorityLink extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyLowPriorityLink() throws InterruptedException, AWTException 
	{
...
//		messageActions.clickYesacknowledge();
		...
		Assert.assertEquals(notify, "LowPriorityLink");
