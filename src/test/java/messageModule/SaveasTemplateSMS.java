...
public class SaveasTemplateSMS extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifySaveasTemplateSMS() throws InterruptedException, AWTException 
	{
		...
		messageActions.clickNextButton();
		messageActions.clicksaveAsTemplate();
