...
public class AssertPushNotificationIcon extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyPushNotificationIcon() throws InterruptedException, AWTException 
	{
		...
		messageActions.clickNextButton();
		String push=messageActions.assertPushNotificationPopup();
		Assert.assertEquals(push, "Enter title for the post.");
