...
public class AssertConnectPostIcon extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyConnectPostIcon() throws InterruptedException, AWTException 
	{
		...
		messageActions.clickNextButton();
		String post=messageActions.assertConnectPostPopup();
		Assert.assertEquals(post, "Select tags for connect post.");
