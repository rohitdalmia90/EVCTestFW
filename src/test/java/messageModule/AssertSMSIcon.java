...
public class AssertSMSIcon extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifySMSIcon() throws InterruptedException, AWTException 
	{
		...
		messageActions.clicksmsIcon();
		messageActions.clickNextButton();
		String sms=messageActions.assertSMSPopup();
		Assert.assertEquals(sms, "Enter message for the post.");
