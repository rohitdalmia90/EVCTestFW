...
public class AssertEmailIcon extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyEmailIcon() throws InterruptedException, AWTException 
	{
		...
		messageActions.clickNextButton();
		String emailPost=messageActions.assertassertEmailPostPopup();
		Assert.assertEquals(emailPost, "Enter subject for the post.");
