...
public class ClickNextVerifyPopup extends BrowserSelection implements OtherObjects{
	...
	@Test
	public void verifyClickNextVerifyPopup() throws InterruptedException, AWTException 
	{
		...
		String nextPopup=messageActions.assertNextPopup();
		Assert.assertEquals(nextPopup, "Select at least one User Group or a user .");
