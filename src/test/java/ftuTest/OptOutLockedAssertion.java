...
public class OptOutLockedAssertion extends BrowserSelection implements OtherObjects {
...
//	@Test(priority = 5, enabled = true)
	...
	public void verifyFTUAssertion() throws InterruptedException, AWTException {
		...
		Assert.assertEquals(ftuText1, "userPreferances ng-scope greytextborder");
		qaActions.ftuAcademicClick();
		String ftuText3 = qaActions.ftuAcademicColor();
		System.out.println(ftuText3);
		Assert.assertEquals(ftuText3, "userPreferances ng-scope greytextborder");
		String ftuText2 = qaActions.ftuDone();
//		Assert.assertEquals(ftuText2, "btn borderRadius4 btn-block disabled");
