...
public class AssignCategory extends BrowserSelection implements OtherObjects{
...
//		qaActions.editDanceCategoryClick();
		qaActions.connectAudiencesClick();
		qaActions.connectAudiencesEnterText();
		qaActions.selectAudiencesClick();
